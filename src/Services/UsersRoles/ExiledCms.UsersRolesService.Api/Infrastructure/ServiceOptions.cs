...
{
    public string Name { get; set; } = "users-roles-service";

    public string DisplayName { get; set; } = "Users Roles Service";

    public string Version { get; set; } = "1.0.0";

    public string BaseUrl { get; set; } = "http://users-roles-service:8080";
